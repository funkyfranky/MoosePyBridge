...
- broaden AUFTRAG creation helpers beyond the current BAI, BOMBING, BOMBRUNWAY,
  ...
  SEAD, ANTISHIP, STRIKE, INTERCEPT, STRAFING, PATROLZONE, GROUNDESCORT,
  GROUNDATTACK, NAVALENGAGEMENT, AMMOSUPPLY, FUELSUPPLY, REARMING, AIRDEFENSE,
  EWR, ONGUARD, NOTHING, ESCORT, RESCUEHELO, and TROOPTRANSPORT baseline
