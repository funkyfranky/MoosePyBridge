...
def execution_to_dict(execution: OperationalPlanExecution) -> dict[str, Any]:
    return {
        ...
        "mission_generation": execution.mission_generation,
        "audit_session_id": execution.audit_session_id,
...
def execution_from_dict(data: Mapping[str, Any]) -> OperationalPlanExecution:
    return OperationalPlanExecution(
        ...
        mission_generation=_int(data.get("mission_generation")),
        audit_session_id=_text(data.get("audit_session_id")),
